...
extension NetworkManager {
    func getMovieData(page: Int, sortType: SortType ,completion: @escaping (DiscoverMovie) -> Void) {
    ...
    func getReviewMovieDetailData(id: Int, completion: @escaping (MovieReview) -> Void)  {
        let url = URLs.baseURL + "/movie/\(id)/reviews?api_key=" + APIKey.apiKey + "&language=en-US"
        request(from: url, completion: completion)
