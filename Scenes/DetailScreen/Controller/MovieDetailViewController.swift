...
class MovieDetailViewController: UIViewController {
    ...
    @IBAction func didTapAddMovieWatchListButton(_ sender: Any) {
        ...
        // 3
        favoriteMovie.setValue(viewModel.movieDetail?.id, forKeyPath: "id")
        favoriteMovie.setValue(viewModel.movieDetail?.title, forKey: "nameMovie")
        favoriteMovie.setValue(viewModel.movieDetail?.releaseDate, forKey: "releaseDate")
        favoriteMovie.setValue(viewModel.movieDetail?.rateCount, forKey: "rating")
        favoriteMovie.setValue(viewModel.movieDetail?.posterImage, forKey: "avatar")
        // 4
        do {
